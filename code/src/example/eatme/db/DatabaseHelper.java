...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE_FOOD_INDEX = "CREATE UNIQUE INDEX data_idx ON " + TABLE_FOOD + "(ID)";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(CREATE_TABLE_FOOD_INDEX);
	}
	...
	public long insertOrUpdateFood(Food food) {
		...
		return db.replace(TABLE_FOOD, null, values);
	}
